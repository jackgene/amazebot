...
var _jackgene$amazebot$Main$jiffiesInSecond = function (millis) {
	return A2(_elm_lang$core$Basics_ops['%'], (millis / 100) | 0, 10);
};
var _jackgene$amazebot$Main$secondsInMinute = function (millis) {
	return A2(_elm_lang$core$Basics_ops['%'], (millis / 1000) | 0, 60);
};
var _jackgene$amazebot$Main$toMinutes = function (millis) {
	return (((millis / 60) | 0) / 1000) | 0;
};
var _jackgene$amazebot$Main$stopWatchView = function (stopWatch) {
	var millis = stopWatch.millisSinceStart;
	var mins = _elm_lang$core$Basics$toString(
		_jackgene$amazebot$Main$toMinutes(millis));
	var secs = A3(
		_elm_lang$core$String$padLeft,
		2,
		_elm_lang$core$Native_Utils.chr('0'),
		_elm_lang$core$Basics$toString(
			_jackgene$amazebot$Main$secondsInMinute(millis)));
	var jifs = _elm_lang$core$Basics$toString(
		_jackgene$amazebot$Main$jiffiesInSecond(millis));
	return A2(
				...
				A2(
					...
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							secs,
							A2(_elm_lang$core$Basics_ops['++'], '.', jifs))))),
			_1: {ctor: '[]'}
		});
};
	...
	return A2(
		...
		function () {
			...
			if (_p0.ctor === 'StdOut') {
				return {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('stdout'),
					_1: {ctor: '[]'}
				};
			} else {
				return {
...
var _jackgene$amazebot$Main$mmToPixels = function (mm) {
	return mm / 10;
};
var _jackgene$amazebot$Main$wallView = function (wall) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('wall'),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$style(
					{
						...
						_0: {
							...
							_1: A2(
								_elm_lang$core$Basics_ops['++'],
								_elm_lang$core$Basics$toString(
									_jackgene$amazebot$Main$mmToPixels(wall.topLeft.topMm)),
								'px')
						},
						_1: {
							ctor: '::',
							_0: {
								...
								_1: A2(
									_elm_lang$core$Basics_ops['++'],
									_elm_lang$core$Basics$toString(
										_jackgene$amazebot$Main$mmToPixels(wall.topLeft.leftMm)),
									'px')
							},
							_1: {
								ctor: '::',
								_0: {
									...
									_1: A2(
										_elm_lang$core$Basics_ops['++'],
										_elm_lang$core$Basics$toString(
											_jackgene$amazebot$Main$mmToPixels(wall.bottomRightFromTopLeft.topMm)),
										'px')
								},
								_1: {
									ctor: '::',
									_0: {
										...
										_1: A2(
											_elm_lang$core$Basics_ops['++'],
											_elm_lang$core$Basics$toString(
												_jackgene$amazebot$Main$mmToPixels(wall.bottomRightFromTopLeft.leftMm)),
											'px')
									},
									_1: {ctor: '[]'}
								}
	...
	if (_p1.ctor === 'Just') {
		...
		return {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$id('finish'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$style(
							{
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('move robot here'),
					_1: {ctor: '[]'}
				}),
			_1: function () {
	...
	if (_p4.ctor === 'Just') {
		...
		return {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$id('robot'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$style(
							{
...
var _jackgene$amazebot$Main$worldView = F3(
	function (maybeRobot, stopWatch, maybeMaze) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$id('world'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: _jackgene$amazebot$Main$stopWatchView(stopWatch),
				_1: A2(
					_elm_lang$core$Basics_ops['++'],
...
var _jackgene$amazebot$Main$mapDrawInProgress = function (maybeMaze) {
	...
	if (_p6.ctor === 'Just') {
		return _elm_lang$core$Native_Utils.cmp(
			1,
			_elm_lang$core$List$length(_p6._0.wallsHistory)) < 0;
	} else {
		return false;
	}
};
var _jackgene$amazebot$Main$refreshStopWatch = F2(
	function (time, stopWatch) {
		var _p7 = stopWatch.startTime;
		if (_p7.ctor === 'Just') {
			return _elm_lang$core$Native_Utils.update(
				stopWatch,
				{
					millisSinceStart: _elm_lang$core$Basics$round(time - _p7._0)
				});
		} else {
			return _elm_lang$core$Native_Utils.update(
				stopWatch,
...
var _jackgene$amazebot$Main$resetStopWatch = function (stopWatch) {
	return _elm_lang$core$Native_Utils.update(
		stopWatch,
		{startTime: _elm_lang$core$Maybe$Nothing, millisSinceStart: 0});
};
var _jackgene$amazebot$Main$stopStopWatch = function (stopWatch) {
	return _elm_lang$core$Native_Utils.update(
		stopWatch,
		{active: false});
};
var _jackgene$amazebot$Main$startStopWatch = function (stopWatch) {
	return _elm_lang$core$Native_Utils.update(
		stopWatch,
		{active: true});
};
var _jackgene$amazebot$Main$saveAndRunEncoder = function (model) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'lang',
				_1: _elm_lang$core$Json_Encode$string(model.language)
			},
			_1: {
				ctor: '::',
				_0: {
...
var _jackgene$amazebot$Main$localStorageSetItemCmd = _elm_lang$core$Native_Platform.outgoingPort(
	'localStorageSetItemCmd',
	function (v) {
		return [v._0, v._1];
	});
var _jackgene$amazebot$Main$localStorageGetItemCmd = _elm_lang$core$Native_Platform.outgoingPort(
	'localStorageGetItemCmd',
	function (v) {
		return v;
	});
var _jackgene$amazebot$Main$localStorageGetItemSub = _elm_lang$core$Native_Platform.incomingPort(
	'localStorageGetItemSub',
...
var _jackgene$amazebot$Main$codeMirrorFromTextAreaCmd = _elm_lang$core$Native_Platform.outgoingPort(
	'codeMirrorFromTextAreaCmd',
	function (v) {
		return [v._0, v._1];
	});
var _jackgene$amazebot$Main$codeMirrorSetOptionCmd = _elm_lang$core$Native_Platform.outgoingPort(
	'codeMirrorSetOptionCmd',
	function (v) {
		return [v._0, v._1];
	});
var _jackgene$amazebot$Main$codeMirrorDocSetValueCmd = _elm_lang$core$Native_Platform.outgoingPort(
	'codeMirrorDocSetValueCmd',
	function (v) {
		return v;
	});
var _jackgene$amazebot$Main$codeMirrorDocValueChangedSub = _elm_lang$core$Native_Platform.incomingPort('codeMirrorDocValueChangedSub', _elm_lang$core$Json_Decode$string);
var _jackgene$amazebot$Main$codeMirrorFlashLineCmd = _elm_lang$core$Native_Platform.outgoingPort(
	'codeMirrorFlashLineCmd',
	function (v) {
		return v;
	});
var _jackgene$amazebot$Main$showMessageCmd = _elm_lang$core$Native_Platform.outgoingPort(
	'showMessageCmd',
	function (v) {
		return v;
	});
...
var _jackgene$amazebot$Main$pointJsonDecoder = F2(
	function (topField, leftField) {
		return A3(
			_elm_lang$core$Json_Decode$map2,
			_jackgene$amazebot$Main$Point,
			A2(_elm_lang$core$Json_Decode$field, topField, _elm_lang$core$Json_Decode$float),
			A2(_elm_lang$core$Json_Decode$field, leftField, _elm_lang$core$Json_Decode$float));
	});
var _jackgene$amazebot$Main$RobotPosition = F2(
	function (a, b) {
		return {point: a, orientationRad: b};
	});
var _jackgene$amazebot$Main$robotPositionJsonDecoder = A3(
	_elm_lang$core$Json_Decode$map2,
...
var _jackgene$amazebot$Main$wallJsonDecoder = A3(
	_elm_lang$core$Json_Decode$map2,
	_jackgene$amazebot$Main$Wall,
	A2(_jackgene$amazebot$Main$pointJsonDecoder, 't', 'l'),
	A2(_jackgene$amazebot$Main$pointJsonDecoder, 'h', 'w'));
var _jackgene$amazebot$Main$Maze = F2(
	function (a, b) {
		return {finish: a, wallsHistory: b};
	});
var _jackgene$amazebot$Main$mazeJsonDecoder = A3(
	_elm_lang$core$Json_Decode$map2,
	_jackgene$amazebot$Main$Maze,
	A2(_jackgene$amazebot$Main$pointJsonDecoder, 'ft', 'fl'),
	A2(
		_elm_lang$core$Json_Decode$field,
		'w',
		_elm_lang$core$Json_Decode$list(
			_elm_lang$core$Json_Decode$list(_jackgene$amazebot$Main$wallJsonDecoder))));
var _jackgene$amazebot$Main$StopWatch = F3(
	function (a, b, c) {
		return {startTime: a, millisSinceStart: b, active: c};
	});
...
var _jackgene$amazebot$Main$AdvanceStopWatch = function (a) {
	return {ctor: 'AdvanceStopWatch', _0: a};
};
var _jackgene$amazebot$Main$SaveAndRun = {ctor: 'SaveAndRun'};
...
var _jackgene$amazebot$Main$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$href('/maze/level0'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Level 0'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}),
						...
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$href('/maze/level1'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$href('/maze/level2'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
								...
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$href('/maze/level3'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
									...
									_0: A2(
										...
										{ctor: '[]'},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$href('/maze/level4'),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
										...
										_0: A2(
											...
											{ctor: '[]'},
											{
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$href('/maze/random'),
														_1: {ctor: '[]'}
													},
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('Random Maze'),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}),
			...
			_1: {
						...
						_1: {
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onInput(_jackgene$amazebot$Main$SelectLanguage),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$value('java'),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$selected(
														!_elm_lang$core$Native_Utils.eq(model.language, 'py')),
													_1: {ctor: '[]'}
												}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Java 8'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$value('py'),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$selected(
															_elm_lang$core$Native_Utils.eq(model.language, 'py')),
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Python 2.7'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(_jackgene$amazebot$Main$SaveAndRun),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Save & Run'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(_jackgene$amazebot$Main$ClearConsole),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Clear Console'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onClick(_jackgene$amazebot$Main$ResetCode),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Reset Code'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: A3(_jackgene$amazebot$Main$worldView, model.robot, model.stopWatch, model.maze),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
...
var _jackgene$amazebot$Main$AdvanceWallHistory = function (a) {
	return {ctor: 'AdvanceWallHistory', _0: a};
};
var _jackgene$amazebot$Main$ReceivedTemplatedSource = function (a) {
		...
		switch (_p10.ctor) {
				...
				if (_p11.ctor === 'Just') {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{source: _p12}),
						_1: _jackgene$amazebot$Main$codeMirrorDocSetValueCmd(_p12)
					};
				} else {
					return {
						ctor: '_Tuple2',
				...
				if (_p13.ctor === 'Ok') {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{source: _p14}),
						_1: _jackgene$amazebot$Main$codeMirrorDocSetValueCmd(_p14)
					};
				} else {
					return A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							'Error obtaining code template: ',
							_elm_lang$core$Basics$toString(_p13._0)),
						{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
				}
			case 'AdvanceWallHistory':
				var updatedMaze = A2(
					_elm_lang$core$Maybe$map,
					function (maze) {
						var updatedWallsHistory = function () {
							var _p15 = maze.wallsHistory;
							if ((_p15.ctor === '::') && (_p15._1.ctor === '::')) {
								return {ctor: '::', _0: _p15._1._0, _1: _p15._1._1};
							} else {
								return _p15;
							}
						}();
						return _elm_lang$core$Native_Utils.update(
							maze,
							{wallsHistory: updatedWallsHistory});
					},
					model.maze);
				return {
					ctor: '_Tuple2',
			...
			case 'SelectLanguage':
				...
				return {
					...
					_1: _elm_lang$core$Platform_Cmd$batch(
						{
							ctor: '::',
							_0: _jackgene$amazebot$Main$codeMirrorSetOptionCmd(
								{
									ctor: '_Tuple2',
									_0: 'mode',
									_1: _jackgene$amazebot$Main$languageToMediaType(_p16)
								}),
							_1: {
								ctor: '::',
								_0: _jackgene$amazebot$Main$localStorageSetItemCmd(
									{ctor: '_Tuple2', _0: 'lang', _1: _p16}),
								_1: {
									ctor: '::',
									_0: _jackgene$amazebot$Main$localStorageGetItemCmd(
										A2(
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							...
							stopWatch: _jackgene$amazebot$Main$resetStopWatch(model.stopWatch)
						}),
					_1: _elm_lang$core$Platform_Cmd$batch(
						{
							ctor: '::',
							_0: _jackgene$amazebot$Main$localStorageSetItemCmd(
								{ctor: '_Tuple2', _0: 'lang', _1: model.language}),
							_1: {
								ctor: '::',
								_0: _jackgene$amazebot$Main$localStorageSetItemCmd(
									{
								...
								_1: {
									...
									_0: A2(
										...
										A2(
											...
											0,
											_jackgene$amazebot$Main$saveAndRunEncoder(model))),
									_1: {ctor: '[]'}
								}
							}
						})
			...
			case 'AdvanceStopWatch':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							stopWatch: A2(_jackgene$amazebot$Main$refreshStopWatch, _p10._0, model.stopWatch)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ClearConsole':
			...
			case 'ServerCommand':
				...
				if (_p17.ctor === 'Ok') {
					switch (_p17._0) {
						case 'maze':
							var _p18 = A2(_elm_lang$core$Json_Decode$decodeString, _jackgene$amazebot$Main$mazeJsonDecoder, _p27);
							if (_p18.ctor === 'Ok') {
								var _p19 = _p18._0;
								return {
									ctor: '_Tuple2',
										...
										model,
										{
											maze: _elm_lang$core$Maybe$Just(
												_elm_lang$core$Native_Utils.update(
													_p19,
													{
														wallsHistory: _elm_lang$core$List$reverse(_p19.wallsHistory)
													}))
										}),
									_1: _elm_lang$core$Platform_Cmd$none
								};
								...
								return A2(
									_elm_lang$core$Debug$log,
									A2(_elm_lang$core$Basics_ops['++'], 'Error parsing draw maze command: ', _p18._0),
									{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
							}
						case 'init':
							var _p20 = A2(_elm_lang$core$Json_Decode$decodeString, _jackgene$amazebot$Main$robotPositionJsonDecoder, _p27);
							if (_p20.ctor === 'Ok') {
								var _p22 = _p20._0;
								return {
									ctor: '_Tuple2',
									_0: function () {
										var _p21 = A2(
											_elm_lang$core$Json_Decode$decodeString,
											A2(_elm_lang$core$Json_Decode$field, 'run', _elm_lang$core$Json_Decode$bool),
											_p27);
										if (_p21.ctor === 'Ok') {
											if (_p21._0 === true) {
												return _elm_lang$core$Native_Utils.update(
													model,
													{
														...
														stopWatch: _jackgene$amazebot$Main$startStopWatch(model.stopWatch)
													});
											} else {
												return _elm_lang$core$Native_Utils.update(
													model,
											...
											return A2(
												_elm_lang$core$Debug$log,
												A2(_elm_lang$core$Basics_ops['++'], 'Error parsing robot initialization command for run: ', _p21._0),
												model);
										}
									}(),
									_1: _elm_lang$core$Platform_Cmd$none
								...
								return A2(
									_elm_lang$core$Debug$log,
									A2(_elm_lang$core$Basics_ops['++'], 'Error parsing robot initialization command: ', _p20._0),
									{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
							}
						case 'm':
							var _p23 = A2(_elm_lang$core$Json_Decode$decodeString, _jackgene$amazebot$Main$robotPositionJsonDecoder, _p27);
							if (_p23.ctor === 'Ok') {
								return {
									ctor: '_Tuple2',
									_0: _elm_lang$core$Native_Utils.update(
										...
										{
											robot: _elm_lang$core$Maybe$Just(
												A2(_jackgene$amazebot$Main$Robot, _p23._0, true))
										}),
									_1: _elm_lang$core$Platform_Cmd$none
								};
							} else {
								return A2(
									_elm_lang$core$Debug$log,
									A2(_elm_lang$core$Basics_ops['++'], 'Error parsing move robot command: ', _p23._0),
									{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
							}
						case 'msg':
							var _p24 = A2(
							...
							if (_p24.ctor === 'Ok') {
								return {
									...
									_0: _elm_lang$core$Native_Utils.update(
										model,
										{
											stopWatch: _jackgene$amazebot$Main$stopStopWatch(model.stopWatch)
										}),
									_1: _jackgene$amazebot$Main$showMessageCmd(_p24._0)
								};
							} else {
								return A2(
									_elm_lang$core$Debug$log,
									A2(_elm_lang$core$Basics_ops['++'], 'Error parsing message alert command: ', _p24._0),
									{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
							}
						case 'log':
							var _p25 = A2(_elm_lang$core$Json_Decode$decodeString, _jackgene$amazebot$Main$consoleMessageJsonDecoder, _p27);
							if (_p25.ctor === 'Ok') {
								return {
									ctor: '_Tuple2',
									_0: _elm_lang$core$Native_Utils.update(
										model,
										{
											console: {ctor: '::', _0: _p25._0, _1: model.console}
										}),
									_1: A2(
										_elm_lang$core$Task$attempt,
								...
								return A2(
									_elm_lang$core$Debug$log,
									A2(_elm_lang$core$Basics_ops['++'], 'Error parsing console log command: ', _p25._0),
									{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
							}
						case 'l':
							var _p26 = A2(
							...
							if (_p26.ctor === 'Ok') {
								return {
									ctor: '_Tuple2',
									_0: model,
									_1: _jackgene$amazebot$Main$codeMirrorFlashLineCmd(_p26._0)
								};
							} else {
								return A2(
									_elm_lang$core$Debug$log,
									A2(_elm_lang$core$Basics_ops['++'], 'Error parsing line execution command: ', _p26._0),
									{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
							}
						default:
							return A2(
								_elm_lang$core$Debug$log,
								A2(_elm_lang$core$Basics_ops['++'], 'Unhandled command: ', _p27),
								{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
					}
				} else {
					return A2(
						_elm_lang$core$Debug$log,
						A2(_elm_lang$core$Basics_ops['++'], 'Error parsing WebSocket command JSON: ', _p17._0),
						{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
				}
...
var _jackgene$amazebot$Main$ReceivedLocalStorageItem = function (a) {
	return {ctor: 'ReceivedLocalStorageItem', _0: a};
};
var _jackgene$amazebot$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		A2(
			_elm_lang$core$Basics_ops['++'],
			{
				ctor: '::',
				_0: _jackgene$amazebot$Main$codeMirrorDocValueChangedSub(_jackgene$amazebot$Main$ChangeSource),
				_1: {
					ctor: '::',
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				(!_jackgene$amazebot$Main$mapDrawInProgress(model.maze)) ? {ctor: '[]'} : {
					ctor: '::',
					_0: A2(_elm_lang$core$Time$every, 50 * _elm_lang$core$Time$millisecond, _jackgene$amazebot$Main$AdvanceWallHistory),
					_1: {ctor: '[]'}
				},
				(!model.stopWatch.active) ? {ctor: '[]'} : {
					ctor: '::',
					_0: A2(_elm_lang$core$Time$every, 100 * _elm_lang$core$Time$millisecond, _jackgene$amazebot$Main$AdvanceStopWatch),
					_1: {ctor: '[]'}
				})));
};
...
if (typeof _jackgene$amazebot$Main$main !== 'undefined') {
    _jackgene$amazebot$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dom.Error":{"args":[],"tags":{"NotFound":["String"]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Main.Msg":{"args":[],"tags":{"SelectLanguage":["String"],"ServerCommand":["String"],"SendWebSocketKeepAlive":["Time.Time"],"ResetCode":[],"AdvanceStopWatch":["Time.Time"],"ConsoleScrolled":["Result.Result Dom.Error ()"],"SaveAndRun":[],"ChangeSource":["String"],"AdvanceWallHistory":["Time.Time"],"ClearConsole":[],"ReceivedTemplatedSource":["Result.Result Http.Error String"],"ReceivedLocalStorageItem":["Maybe.Maybe String"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Time.Time":{"args":[],"type":"Float"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
