...
var _jackgene$amazebot$Main$webSocketUrl = function (request) {
	return A2(
		...
		A2(
			_elm_lang$core$Basics_ops['++'],
			'://',
			A2(_elm_lang$core$Basics_ops['++'], request.hostPath, '/simulation')));
};
var _jackgene$amazebot$Main$codeMirrorFromTextArea = _elm_lang$core$Native_Platform.outgoingPort(
...
var _jackgene$amazebot$Main$Request = F2(
	function (a, b) {
		return {secure: a, hostPath: b};
	});
...
var _jackgene$amazebot$Main$ReceiveTemplatedSource = function (a) {
	return {ctor: 'ReceiveTemplatedSource', _0: a};
};
var _jackgene$amazebot$Main$loadCodeTemplate = F2(
	function (request, language) {
		return A2(
			_elm_lang$http$Http$send,
			_jackgene$amazebot$Main$ReceiveTemplatedSource,
...
var _jackgene$amazebot$Main$init = function (flags) {
	...
	return {
		...
		_1: _elm_lang$core$Platform_Cmd$batch(
			{
				ctor: '::',
				_0: A2(_jackgene$amazebot$Main$loadCodeTemplate, flags, language),
				_1: {
					ctor: '::',
					_0: _jackgene$amazebot$Main$codeMirrorFromTextArea(
						{ctor: '_Tuple2', _0: 'source', _1: 'text/x-java'}),
					_1: {ctor: '[]'}
				}
			})
	};
			...
			case 'SelectLanguage':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{language: _p8}),
					_1: A2(_jackgene$amazebot$Main$loadCodeTemplate, model.request, _p8)
				};
											...
											_elm_lang$html$Html$option,
											{
												...
												_1: {
													...
													_0: _elm_lang$html$Html_Attributes$selected(
														!_elm_lang$core$Native_Utils.eq(model.language, 'python')),
													_1: {ctor: '[]'}
												}
											},
											{
			...
			return A2(
				...
				function (secure) {
					return _elm_lang$core$Json_Decode$succeed(
						{hostPath: hostPath, secure: secure});
				},
				A2(_elm_lang$core$Json_Decode$field, 'secure', _elm_lang$core$Json_Decode$bool));
		},
		A2(_elm_lang$core$Json_Decode$field, 'hostPath', _elm_lang$core$Json_Decode$string)));

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _jackgene$amazebot$Main$main !== 'undefined') {
    _jackgene$amazebot$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Main.Msg":{"args":[],"tags":{"ReceiveTemplatedSource":["Result.Result Http.Error String"],"SelectLanguage":["String"],"ServerCommand":["String"],"ResetCode":[],"SaveAndRun":[],"ChangeSource":["String"],"ClearConsole":[]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
