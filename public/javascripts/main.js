		...
		switch (_p8.ctor) {
				...
				if (_p9.ctor === 'Just') {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{source: _p10}),
						_1: _jackgene$amazebot$Main$codeMirrorDocSetValueCmd(_p10)
					};
				} else {
					return {
						ctor: '_Tuple2',
				...
				var updatedMaze = A2(
					...
					function (maze) {
						var updatedWallsHistory = function () {
							var _p13 = maze.wallsHistory;
							if ((_p13.ctor === '::') && (_p13._1.ctor === '::')) {
								return {ctor: '::', _0: _p13._1._0, _1: _p13._1._1};
							} else {
								return _p13;
							}
						}();
							...
							_0: _jackgene$amazebot$Main$codeMirrorSetOptionCmd(
								{
									ctor: '_Tuple2',
									_0: 'mode',
									_1: _jackgene$amazebot$Main$languageToMediaType(_p14)
								}),
							_1: {
								ctor: '::',
								_0: _jackgene$amazebot$Main$localStorageGetItemCmd(
			...
			default:
				...
				if (_p15.ctor === 'Ok') {
					switch (_p15._0) {
						case 'maze':
							var _p16 = A2(_elm_lang$core$Json_Decode$decodeString, _jackgene$amazebot$Main$mazeJsonDecoder, _p23);
							if (_p16.ctor === 'Ok') {
								var _p17 = _p16._0;
								return {
									ctor: '_Tuple2',
										...
										model,
										{
											maze: _elm_lang$core$Maybe$Just(
												_elm_lang$core$Native_Utils.update(
													_p17,
													{
														wallsHistory: _elm_lang$core$List$reverse(_p17.wallsHistory)
													}))
										}),
									_1: _elm_lang$core$Platform_Cmd$none
								};
								...
								return A2(
									_elm_lang$core$Debug$log,
									A2(_elm_lang$core$Basics_ops['++'], 'Error parsing draw maze command: ', _p16._0),
									{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
							}
						case 'init':
							var _p18 = A2(_elm_lang$core$Json_Decode$decodeString, _jackgene$amazebot$Main$robotPositionJsonDecoder, _p23);
							if (_p18.ctor === 'Ok') {
								return {
									ctor: '_Tuple2',
									_0: _elm_lang$core$Native_Utils.update(
										model,
										{
											robotPosition: _elm_lang$core$Maybe$Just(_p18._0)
										}),
									_1: _elm_lang$core$Platform_Cmd$none
								};
							} else {
								return A2(
									_elm_lang$core$Debug$log,
									A2(_elm_lang$core$Basics_ops['++'], 'Error parsing robot initialization command: ', _p18._0),
									{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
							}
						case 'm':
							var _p19 = A2(_elm_lang$core$Json_Decode$decodeString, _jackgene$amazebot$Main$robotPositionJsonDecoder, _p23);
							if (_p19.ctor === 'Ok') {
								return {
									ctor: '_Tuple2',
									_0: _elm_lang$core$Native_Utils.update(
								...
								return A2(
									_elm_lang$core$Debug$log,
									A2(_elm_lang$core$Basics_ops['++'], 'Error parsing move robot command: ', _p19._0),
									{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
							}
						case 'msg':
							var _p20 = A2(
							...
							if (_p20.ctor === 'Ok') {
								return {
									ctor: '_Tuple2',
									_0: model,
									_1: _jackgene$amazebot$Main$showMessageCmd(_p20._0)
								};
							} else {
								return A2(
									_elm_lang$core$Debug$log,
									A2(_elm_lang$core$Basics_ops['++'], 'Error parsing message alert command: ', _p20._0),
									{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
							}
						case 'log':
							var _p21 = A2(_elm_lang$core$Json_Decode$decodeString, _jackgene$amazebot$Main$consoleMessageJsonDecoder, _p23);
							if (_p21.ctor === 'Ok') {
								return {
									ctor: '_Tuple2',
									_0: _elm_lang$core$Native_Utils.update(
										model,
										{
											console: {ctor: '::', _0: _p21._0, _1: model.console}
										}),
									_1: _elm_lang$core$Platform_Cmd$none
								};
							} else {
								return A2(
									_elm_lang$core$Debug$log,
									A2(_elm_lang$core$Basics_ops['++'], 'Error parsing console log command: ', _p21._0),
									{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
							}
						case 'l':
							var _p22 = A2(
							...
							if (_p22.ctor === 'Ok') {
								return {
									ctor: '_Tuple2',
									_0: model,
									_1: _jackgene$amazebot$Main$codeMirrorFlashLineCmd(_p22._0)
								};
							} else {
								return A2(
									_elm_lang$core$Debug$log,
									A2(_elm_lang$core$Basics_ops['++'], 'Error parsing line execution command: ', _p22._0),
									{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
							}
						default:
							return A2(
								_elm_lang$core$Debug$log,
								A2(_elm_lang$core$Basics_ops['++'], 'Unhandled command: ', _p23),
								{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
					}
				} else {
					return A2(
						_elm_lang$core$Debug$log,
						A2(_elm_lang$core$Basics_ops['++'], 'Error parsing WebSocket command JSON: ', _p15._0),
						{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
				}
		}
	});
...
var _jackgene$amazebot$Main$subscriptions = function (_p24) {
	var _p25 = _p24;
			...
			_1: {
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							_elm_lang$websocket$WebSocket$listen,
							_jackgene$amazebot$Main$webSocketUrl(_p25.request),
