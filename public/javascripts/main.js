									...
									_0: _elm_lang$core$Native_Utils.update(
										model,
										{
											...
											startingPosition: _elm_lang$core$Maybe$Just(
												A2(_elm_lang$core$Maybe$withDefault, _p22, model.startingPosition)),
											stopWatch: function () {
												var _p21 = model.startingPosition;
												if (_p21.ctor === 'Just') {
													return _jackgene$amazebot$Main$startStopWatch(model.stopWatch);
												} else {
													return model.stopWatch;
												}
											}()
										}),
									_1: _elm_lang$core$Platform_Cmd$none
