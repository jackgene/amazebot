...
if (typeof _jackgene$amazebot$Main$main !== 'undefined') {
    _jackgene$amazebot$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Main.Msg":{"args":[],"tags":{"SelectLanguage":["String"],"ServerCommand":["String"],"SendWebSocketKeepAlive":["Time.Time"],"ResetCode":[],"AdvanceStopWatch":["Time.Time"],"SaveAndRun":[],"ChangeSource":["String"],"AdvanceWallHistory":["Time.Time"],"ClearConsole":[],"ReceivedTemplatedSource":["Result.Result Http.Error String"],"NoOp":[],"ReceivedLocalStorageItem":["Maybe.Maybe String"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Time.Time":{"args":[],"type":"Float"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
